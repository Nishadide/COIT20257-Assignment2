...
public class IntegrationTest {
    ...
    public static void main(String[] args) throws Exception {
            ...
            public void run() {
                try {
                    device = new DeviceMain(
                            SecurityKeys.forDeviceLayer("keys"));
        ...
        System.out.println("\n=== AUTHENTICATE ===");
        conn.authenticate();
        // Demo On, on BOTH sides, so the cipher texts can be compared.
        server.getDemoLogger().setDemoOn(true);
        device.getDemoLogger().setDemoOn(true);
        Thread.sleep(500);
